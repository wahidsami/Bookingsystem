...
--
-- Name: financial_ledger_entries; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.financial_ledger_entries (
    ...
    "entityId" uuid NOT NULL,
    amount numeric(10,2) NOT NULL,
    currency character varying(255) DEFAULT 'SAR'::character varying,
...
--
-- Name: financial_ledger_entries financial_ledger_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: financial_ledger_entries_created_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX financial_ledger_entries_created_at ON public.financial_ledger_entries USING btree ("createdAt");


--
-- Name: financial_ledger_entries_entity_type_entity_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX financial_ledger_entries_entity_type_entity_id ON public.financial_ledger_entries USING btree ("entityType", "entityId");


--
-- Name: financial_ledger_entries_tenant_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX financial_ledger_entries_tenant_id ON public.financial_ledger_entries USING btree ("tenantId");
...
--
-- Name: financial_ledger_entries financial_ledger_entries_customerId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.financial_ledger_entries
    ADD CONSTRAINT "financial_ledger_entries_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES public.platform_users(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: financial_ledger_entries financial_ledger_entries_tenantId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.financial_ledger_entries
    ADD CONSTRAINT "financial_ledger_entries_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES public.tenants(id) ON UPDATE CASCADE ON DELETE CASCADE;
