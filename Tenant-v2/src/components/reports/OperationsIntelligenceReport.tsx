...
type OperationsTab = 'sales-overview' | 'sales-list' | 'sales-log-details' | 'discount-summary' | 'customer-overview' | 'employee-performance' | 'service-performance' | 'product-performance';
