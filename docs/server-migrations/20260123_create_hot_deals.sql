...
CREATE INDEX IF NOT EXISTS idx_hot_deals_tenant ON hot_deals(tenant_id);
CREATE INDEX IF NOT EXISTS idx_hot_deals_service ON hot_deals(service_id);
CREATE INDEX IF NOT EXISTS idx_hot_deals_status ON hot_deals(status);
CREATE INDEX IF NOT EXISTS idx_hot_deals_validity ON hot_deals(valid_from, valid_until);
CREATE INDEX IF NOT EXISTS idx_hot_deals_active ON hot_deals(status, is_active, valid_until)
