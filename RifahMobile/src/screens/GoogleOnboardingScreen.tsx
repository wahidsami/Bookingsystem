...
const styles = StyleSheet.create({
    ...
    errorContainer: { backgroundColor: '#FEE2E2', padding: spacing.md, borderRadius: 14, marginBottom: spacing.md, borderWidth: 1, borderColor: '#FCA5A5' },
    ...
    readOnlyInput: { backgroundColor: '#F3F0FF' },
    primaryButton: {
